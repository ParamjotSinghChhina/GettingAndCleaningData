This script takes the raw data (a 561-feature vector with time and frequency domain variables computed from the accelerometers from the Samsung Galaxy S smartphone) and transforms it into tidy data. Following functions are performed by this script:
